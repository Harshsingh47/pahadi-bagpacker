  ...
  return (
    <div className="pt-36 pb-24 bg-slate-950 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 space-y-8">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold text-white uppercase font-heading leading-tight">
        ...
        <img src="https://images.unsplash.com/photo-1597074866923-dc0589150358?auto=format&fit=crop&w=1200&q=80" alt="Spiti Valley" className="w-full h-96 object-cover rounded-3xl border border-slate-800" />
        ...
        <div className="space-y-6 text-slate-300 text-sm leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-white uppercase font-heading">1. Vehicle Preparation & Ground Clearance</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-white uppercase font-heading">2. Acclimatization & AMS Precautions</h3>
          <p>
          ...
          <div className="p-6 bg-slate-900 border border-emerald-500/40 rounded-2xl">
            <h4 className="font-bold text-emerald-400 text-base mb-2">Want to Experience Spiti with Local Experts?</h4>
            <p className="text-xs text-slate-300 mb-4">Book our guided 7-Day Spiti Circuit SUV trip or rent a self-drive Thar 4x4 with full permit assistance.</p>
