    ...
    <div className="pt-36 pb-24 bg-[#F8FAF9] min-h-screen">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
          <div>
            <span className="px-3 py-1 bg-emerald-50 text-emerald-800 border border-emerald-200 rounded-full text-xs font-bold">Liquid Cooled 450cc</span>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 text-right shrink-0">
            ...
            <div className="text-3xl font-extrabold text-emerald-700">₹1,800 <span className="text-xs text-slate-500">/ day</span></div>
            <span className="text-[11px] text-slate-500">Security Deposit: ₹5,000</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="bg-white border border-slate-200/80 p-6 rounded-2xl space-y-4 text-xs">
              ...
              <Link href={`/booking?bike=${slug}`} className="w-full block text-center py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold uppercase rounded-xl shadow-lg">
                Book Bike Now &rarr;
              </Link>
            </div>
          </div>
