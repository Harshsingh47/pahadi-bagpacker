  ...
  return (
    <div className="pt-36 pb-24 bg-slate-950 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 text-center mb-16">
        <span className="text-xs uppercase tracking-widest font-mono text-emerald-400 font-semibold">OUR STORY & VISION</span>
        <h1 className="text-4xl sm:text-6xl font-extrabold text-white mt-2 uppercase font-heading leading-tight">
          BORN IN THE MOUNTAINS.<br />
          <span className="text-emerald-400">BUILT FOR ADVENTURE.</span>
        </h1>
        <p className="text-slate-300 text-base max-w-2xl mx-auto mt-4 leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          <h2 className="text-3xl font-extrabold text-white mb-6 uppercase font-heading">OUR MISSION</h2>
          ...
          <div className="grid grid-cols-2 gap-4 text-xs font-semibold">
            <div className="bg-slate-900 p-4 rounded-xl border border-slate-800">
              ...
              <strong className="text-white block">Eco-Travel Principles</strong>
              <span className="text-slate-400 text-[11px]">Strict Leave-No-Trace camping policy on all Himalayan trails.</span>
            </div>
            <div className="bg-slate-900 p-4 rounded-xl border border-slate-800">
              <span className="text-emerald-400 text-lg block mb-1">🏔️</span>
              <strong className="text-white block">Local Guides Only</strong>
              <span className="text-slate-400 text-[11px]">100% of our trek leaders and drivers are native Himalayan residents.</span>
            </div>
          </div>
        </div>
